...
class PostLocationTestCase(TestCase):
    ...
    def setUp(cls):
        ...
        cls.user = UserFactory(phone_number="01011112222", email="wafflemarket@test.com", username="steve")
        ...
        cls.location2 = LocationFactory(code="1111011100", place_name="서울특별시 종로구 옥인동")
        LocationNeighborhood.objects.create(location=cls.location1, neighborhood=cls.location2)

        cls.post_data = {"location_code": "1111011700"}
...
class GetNeighborhoodTestCase(TestCase):
    ...
    def setUp(cls):
        ...
        cls.location2 = LocationFactory(code="1111011100", place_name="서울특별시 종로구 옥인동")
        LocationNeighborhood.objects.create(location=cls.location1, neighborhood=cls.location2)
        cls.location3 = LocationFactory(code="1111010100", place_name="서울특별시 종로구 청운동")
