...
class Location(models.Model):
    ...
    neighbor_relationships = models.ManyToManyField(
        "self", through="LocationNeighborhood", symmetrical=False
    )


class LocationNeighborhood(models.Model):
    location = models.ForeignKey(
        Location, related_name="neighborhoods", on_delete=models.CASCADE
    )
